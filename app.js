...
let trackList = [
    {
        name: "Lâu Dài",
        artist: "Ran x CM1X",
        path: "./music/laudai.mp3",
    },
    {
        name: "Simple Love",
        artist: "Obito x Seachains",
        path: "./music/Simple Love.mp3",
    },
    {
        name: "Tình Ka Ngọt Ngào",
        artist: "LẬP NGUYÊN x YẾN NỒI CƠM ĐIỆN",
        path: "./music/tinhkangotngao.mp3",
    },
];
